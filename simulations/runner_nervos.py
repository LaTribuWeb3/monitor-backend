...
aggregator_path = ".." + os.path.sep + "monitor-backend" + os.path.sep + "yokaiswap" + os.path.sep + "data.json"
lending_platform_json_file = ".." + os.path.sep + "monitor-backend" + os.path.sep + "Hadouken" + os.path.sep + "0x1C2b0bC50633EB1cec9157bd702980fD9ED53EC8_data.json"
